...
Por ejemplo, si ponemos en un tocadiscos un disco que solo emite la 
nota _LA_, el surco del vinilo hará vibrar la aguja del tocadiscos 440
veces por segundo, es decir 440Hz, esa es la frecuencia del _LA_, esa 
frecuencia no tiene problema en propagarse a traves del aire como onda 
sonora, pero si queremos que ese _LA_ viaje de Manacor a Inca, no podemos
