...
no tiene problema en propagarse a traves del aire como onda sonora, 
...
microfono y una antena, pero ya hemos visto que frecuencias de menos de
10kHz (10.000Hz)  tienen problemas para propagarse ya que su longitud 
de onda es mayor que la atmosfera de la Tierra (además de otros 
...
Las ondas pordadoras, en la TV analógica se clasificaban en portadora
de vídeo (Pv), portadora de color (Pc) y portadora de sonido (Ps),
estas portadoras utilizaban los 8MHz del canal, aunque estaban
separadas una distancia según el estandar que se utilizase.
...
05.01 - Medicion de parámetros de la señal de televisión analógica
------------------------------------------------------------------
...
### 05.01.02 ROE (Relacion de Onda Estacionaria)
Este parámetro indica que proporción de la onda es reflejada. Si la
onda reflejada es nula, la amplitud de la onda original será constante,
ya que no hay reflejo que interfiera, por lo que la ROE será 1, en
cambio si se refleja parte de la onda habrá puntos donde la onda sume
a la original y puntos donde reste y la ROE será mayor que 1.
Finalmente en el caso de que se reflejase toda, habría puntos con valor
0 y la ROE tenderia a infinito.

![Onda estacionaria][img_05.01.01]

Se calcula como:

    ROE = 10 log Z_2 over Z_1
...
de onda"
[img_02.04]: img/escala_logaritmica.png "Escala logarítmica"
[img_05.01.02]: img/ROE.gif "Onda estacionaria"
